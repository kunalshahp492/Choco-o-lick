  ...
  <nav class="nav navbar-expand navbar-fixed-top my-navbar">
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand navbar-nav navbar-left" style="font-size:60px;" href="index.html">D&eacute;licieux</a>                                          
...
if($h==1)
{
    ...
    $result=$conn->query($sql);
		...
		{	
			$conn->close();
      $h="<h1 style='color:green'><i class='large material-icons'>check</i>Your order was placed successfully.</h1><p>It will be delivered in 3-5 business days.</p>";
		}
		else 
		{
...
<footer class="container-fluid text-center ">
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <a id="logo" style="" href="index.html">D&eacute;licieux</a>
            <span id="cr"> © 2020 D&eacute;licieux. All rights reserved.</span>
          </div>
        
          <div class="col-sm-5 col-md-5">
            <a href="index.html?p=about">ABOUT US</a>
            <a href="index.html?p=contact">CONTACT US</a>    
          </div>
