...
$orderData = [
    'receipt'         => 3456,
    'amount'          => $totalsum * 100, // 2000 rupees in paise
    'currency'        => 'INR',
...
$sql = "INSERT INTO orders(user_id,rpid) VALUES ('".$userid."','".$_SESSION['razorpay_order_id']."')";
if ($conn->query($sql) == TRUE)
{
    ...
    $sql = "SELECT * FROM orders WHERE user_id='".$userid."' AND rpid='".$_SESSION['razorpay_order_id']."'";
...
$sql = "UPDATE cart SET ord_id=".$oid." WHERE user_id='".$userid."'";
if ($conn->query($sql) == TRUE)
{
